...
This project analyzes an **IMDB movie dataset** to extract insights about trends in movies, ratings, genres, and more. The goal is to explore the data, visualize patterns, and understand factors that affect movie ratings and popularity.

## Dataset

* **Source:** IMDB Dataset from Kaggle
* **Contains:** Movie titles, genres, ratings, release year, votes, and other metadata.

## Objectives

* Explore trends in movie ratings over the years.
* Analyze the popularity of genres.
* Identify patterns between ratings and popularity.
* Visualize key insights to understand movie industry trends.
...
1. **Data Cleaning & Wrangling** – Handling missing values, correcting data types, and preprocessing the dataset.
